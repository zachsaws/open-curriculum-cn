...
const I18N = {
  'zh-CN': {
    ...
    btn_fly_to: '双击飞到该学科',
    map_title: '概念地图',
    map_subtitle: '学科 · 学段 · 领域',
    map_no_selection: '← 选一个节点开始',
    map_collapse_all: '全部收起',
    map_expand_all: '全部展开',
    map_branch_only: '只显示本分支',
    map_show_all: '显示全部',
    map_focus: '聚焦',
    map_count: '个',
    card_difficulty: '难度',
    ...
    card_examples: '📚 课标例题',
    card_assessment: '🎯 评估提示',
    card_meta_type: '类型',
    card_meta_age: '年龄段',
    card_meta_centrality: '中心度',
    card_prereq: '直接先决',
    card_unlocks: '解锁后继',
  ...
  'zh-TW': {
    ...
    btn_fly_to: '雙擊飛到該學科',
    map_title: '概念地圖',
    map_subtitle: '學科 · 學段 · 領域',
    map_no_selection: '← 選一個節點開始',
    map_collapse_all: '全部收起',
    map_expand_all: '全部展開',
    map_branch_only: '只顯示本分支',
    map_show_all: '顯示全部',
    map_focus: '聚焦',
    map_count: '個',
    card_difficulty: '難度',
  ...
  'en': {
    ...
    btn_mode_force: 'Graph',
    btn_mode_map: 'Concept Map',
    ...
    map_title: 'Concept Map',
    map_subtitle: 'Subject · Stage · Domain',
    map_no_selection: '← Select a node to start',
    map_collapse_all: 'Collapse all',
    map_expand_all: 'Expand all',
    map_branch_only: 'Show branch only',
    ...
    card_assessment: '🎯 Assessment Prompt',
    card_meta_type: 'Type',
    card_meta_age: 'Age Range',
    card_meta_centrality: 'Centrality',
